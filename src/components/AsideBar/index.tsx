...
export const AsideBar = () => {
  ...
  const continueWithDelivery = () => {
    items.length > 0 ? setView('delivery') : alert('Adicione items ao carrinho')
  }
            ...
            <S.StyledForm>
              <S.InputGroup>
                ...
                <input
                  ...
                  className={checkInputHasError('customer') ? 'error' : ''}
                />{' '}
                {checkInputHasError('customer') && (
                  <div className="error-message">{form.errors.customer}</div>
                )}
              </S.InputGroup>
              <S.InputGroup>
              ...
              <div className="cep-number">
                <S.InputGroup>
                  ...
                  {checkInputHasError('cep') && (
                    <div className="error-message">{form.errors.cep}</div>
                  )}
                </S.InputGroup>
                <S.InputGroup>
                  ...
                  <input
                    ...
                    onChange={form.handleChange}
                    onBlur={form.handleBlur}
                    className={checkInputHasError('homeNumber') ? 'error' : ''}
                  />
                  {checkInputHasError('homeNumber') && (
                    <div className="error-message">
                      {form.errors.homeNumber}
                    </div>
                  )}
                </S.InputGroup>
              </div>
              <S.InputGroup>
                ...
                <input
                  ...
                  className={checkInputHasError('city') ? 'error' : ''}
                />
                {checkInputHasError('apartment') && (
                  <div className="error-message">{form.errors.apartment}</div>
                )}
              </S.InputGroup>
            ...
            <S.StyledForm onSubmit={form.handleSubmit}>
              <S.InputGroup>
                ...
                {checkInputHasError('cardOwner') && (
                  <div className="error-message">{form.errors.cardOwner}</div>
                )}
              </S.InputGroup>
              <div className="card-code">
                ...
                <S.InputGroup>
                  ...
                  {checkInputHasError('cardCode') && (
                    <div className="error-message">{form.errors.cardCode}</div>
                  )}
                </S.InputGroup>
              </div>
              <div className="cep-number">
                <S.InputGroup>
                  ...
                  <input
                    ...
                    id="monthDue"
                    name="monthDue"
                    value={form.values.monthDue}
                    onChange={form.handleChange}
                    onBlur={form.handleBlur}
                    className={checkInputHasError('monthDue') ? 'error' : ''}
                  />
                  {checkInputHasError('monthDue') && (
                    <div className="error-message">{form.errors.monthDue}</div>
                  )}
                </S.InputGroup>
                <S.InputGroup>
                  ...
                  <input
                    ...
                    id="yearDue"
                    name="yearDue"
                    value={form.values.yearDue}
                    onChange={form.handleChange}
                    onBlur={form.handleBlur}
                    className={checkInputHasError('yearDue') ? 'error' : ''}
                  />
                  {checkInputHasError('yearDue') && (
                    <div className="error-message">{form.errors.yearDue}</div>
                  )}
                </S.InputGroup>
              </div>
              <Button
        ...
        {view === 'confirmation' && (
          <>
            ...
            <Button
              ...
              name="add"
              onClick={() => {
                closeCart(), clearCart(), setView('cart')
              }}
            >
              Concluir
            </Button>
